      ...
      {quote.items.map((item) => (
        <div key={item.id} className="border border-border rounded-lg p-4 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <div className="font-medium text-sm text-muted-foreground mb-1">Antal</div>
              <div className="text-card-foreground">{item.quantity}</div>
            </div>
            <div>
              <div className="font-medium text-sm text-muted-foreground mb-1">Enhet</div>
              <div className="text-card-foreground">{item.unit}</div>
            </div>
            <div>
              <div className="font-medium text-sm text-muted-foreground mb-1">Á pris</div>
              <div className="text-card-foreground">{item.price.toLocaleString()} kr</div>
            </div>
            <div>
              <div className="font-medium text-sm text-muted-foreground mb-1">Rabatt</div>
